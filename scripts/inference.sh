...
# splits=("test")
wandb_project=inference-2025

inferences_dir=/home/annajungbluth/inferences

num_workers=6
criterion_best_model=best
cyclone_prediction=True

wandb_runids=("h3158clx") # "s9hs4usz" "2l7ldorg") # mae-stack, satmae-msi, mae-stack-stack
finetuned_dir=/data/2025-esl-3dclouds-extremes-models/2025-swinmae-finetuning
