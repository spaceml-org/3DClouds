...
inferences_dir=/mnt/e/Data/3DClouds/models/finetune_outputs/NeurIPS2025/runs/satmae-awhu8gtx-finetuning-clouds-bdwsa15d

num_workers=10
criterion_best_model=best
cyclone_prediction=True

wandb_runids=("bdwsa15d") # "s9hs4usz" "2l7ldorg") # mae-stack, satmae-msi, mae-stack-stack
finetuned_dir=/mnt/e/Data/3DClouds/models/finetune_outputs/NeurIPS2025/checkpoints/satmae-awhu8gtx-finetuning-clouds-bdwsa15d
