...
inferences_dir=/mnt/e/Data/3DClouds/models/finetune_outputs/NeurIPS2025/runs/unet-baseline-multivar-multisat-63it0bw9

num_workers=10
criterion_best_model=best
cyclone_prediction=True

wandb_runids=("63it0bw9") # "s9hs4usz" "2l7ldorg") # mae-stack, satmae-msi, mae-stack-stack
finetuned_dir=/mnt/e/Data/3DClouds/models/finetune_outputs/NeurIPS2025/checkpoints/unet-baseline-multivar-multisat-63it0bw9
