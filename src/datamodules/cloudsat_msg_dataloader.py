...
class CloudsatMSGDataModule(LightningDataModule):
    """ LightningDataModule for CloudSat-paired Meteosat (MSG) satellite data. """
    ...
    def __init__(
        ...
        """ Initialize CloudsatMSGDataModule.

            Parameters
            ----------
            data_dir : str. Path to the directory containing CloudSat-MSG NetCDF files.
