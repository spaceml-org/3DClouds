...
from src.datamodules.cloudsat_goes_dataset import CloudsatGOESDataset
...
class CloudsatGOESDataModule(LightningDataModule):
    ...
    def __init__(
        ...
        self.train_dataset = CloudsatGOESDataset(
        ...
        self.test_dataset = CloudsatGOESDataset(
        ...
        self.val_dataset = CloudsatGOESDataset(
        ...
        logger.info("CLOUDSAT-GOES DataModule initialized ...")
