...
from src.datamodules.himawari_dataset import HIMAWARIDataset
from src.utils import get_list_filenames, get_split


class HIMAWARIDataModule(LightningDataModule):
    def __init__(
        self,
        data_dir,
        ...
        self.train_dataset = HIMAWARIDataset(
        ...
        self.test_dataset = HIMAWARIDataset(
        ...
        self.val_dataset = HIMAWARIDataset(
        ...
        logger.info("HIMAWARI DataModule initialized ...")
